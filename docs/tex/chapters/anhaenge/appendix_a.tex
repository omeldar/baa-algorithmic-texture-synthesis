...
\begin{figure}[H]
    ...
    {C1-level architecture context diagram of the prototype.}
    \label{fig:c4-c1}
\end{figure}
...
\begin{figure}[H]
    ...
    {C3-level diagram of the texture definition core, showing how texture methods and their parameters are defined centrally.}
...
\begin{figure}[H]
    ...
    {C3-level diagram of the WebGPU shader pipeline used for GPU-based procedural texture generation.}
...
\begin{figure}[H]
    ...
    {C3-level diagram of the web user interface, including the interaction between the Texture Synthesis Lab and the Terrain Explorer.}
    \label{fig:c4-webui}
\end{figure}