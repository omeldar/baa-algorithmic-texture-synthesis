...
Various systems and tools for procedural texture synthesis already exist in industry and research. Dedicated material tools such as Adobe Substance 3D Designer \cite{substance_designer} and Material Maker \cite{material_maker} use node-based workflows to create textures and materials through procedural operations. Larger graphics environments such as Blender \cite{blender}, Houdini \cite{houdini}, and Unreal Engine \cite{unreal_engine} also integrate procedural texturing into rendering and content creation pipelines.

Research continues to investigate topics such as semantic procedural generation, optimization-based texture approximation, and AI-assisted material generation \cite{wang2017semantic}. These approaches aim to automate procedural workflows and improve the approximation of target textures.
